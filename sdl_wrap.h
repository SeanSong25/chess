...
class Screen {
  ...
  public:
    ...
    Screen(Screen &&o) : window{o.window}, render{o.render}, w{o.w}, h{o.h}, screenName{std::move(o.screenName)}, rects{std::move(o.rects)}, msgs{std::move(o.msgs)}, fonts{std::move(o.fonts)}, imgs{std::move(o.imgs)} {
        o.window = nullptr;
        o.render = nullptr;
    }
